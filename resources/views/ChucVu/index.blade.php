                    ...
                    <div class="card-content">
                        ...
                        <table id="bootstrap-table" class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td><?PHP  echo($i++) ?></td>
                                    <td>{{$Chucvu->nameChucvu}}</td>
                                   {{-- sửa --}}
                                    <td><a class="btn btn-fill btn-info" href="{{ route('Chucvu.edit', $Chucvu->idChucVu) }}">Sửa</a></td>
                                    {{-- Xóa --}}
                                    <td>
                                        <form action="{{ route('Chucvu.destroy', $Chucvu->idChucVu) }}" method="post">
                                            @method('DELETE')
                                            @csrf
