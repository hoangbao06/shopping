                        ...
                        <table id="bootstrap-table" class="table">
                            ...
                            <tbody>
                                <tr>
                                   ...
                                   {{-- sửa --}}
                                    <td><a class="btn btn-fill btn-info" href="{{ route('DuyetKhoHang.edit',$KhoHang->idKhoHang) }}">Duyệt</a></td>
                                    {{-- Xóa --}}
                                    {{-- <td>
                                        <form action="{{ route('KhoHang.destroy', $KhoHang->idKhoHang) }}" method="post">
                                            @method('DELETE')
                                            @csrf
