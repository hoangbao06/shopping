    ...
    <nav class="navbar navbar-transparent navbar-absolute">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../dashboard/overview.html">Ảo Thật Đấy</a>
            </div>
    ...
    <div class="wrapper wrapper-full-page">
        ...
        <!--   you can change the color of the filter page using: data-color="blue | azure | green | orange | red | purple" -->
                                ...
                                <div class="card" data-background="color" data-color="blue">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password" placeholder="Nhập Mậu Khẩu" class="form-control input-no-border">
                                        </div>
                                    </div>
                                    <div class="card-footer text-center">
                                        ...
                                        @endif
                                        <button type="submit" class="btn btn-fill btn-wd ">Vào ôii</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        	...
        	<footer class="footer footer-transparent">
                <div class="container">
                    <div class="copyright">
                        &copy; <script>document.write(new Date().getFullYear())</script>, made with <i class="fa fa-heart heart"></i> by <a href="https://www.youtube.com/watch?v=DKL_GpIDMLk">Hoàng Bảo</a>
                    </div>
                </div>
            </footer>
        </div>
